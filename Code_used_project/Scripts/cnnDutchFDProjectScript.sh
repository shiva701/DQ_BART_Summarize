...
python run_summarization_no_trainer_cnnDutch.py --model_name_or_path ainize/bart-base-cnn --dataset_name ml6team/cnn_dailymail_nl --dataset_config_name 3.0.0 --pred_distill --intermediate_distill --num_train_epochs 20 --weight_bits 2 --do_train --do_test --distill_encoder 1 --distill_decoder 1 --learning_rate 3e-5 --per_device_train_batch_size 16