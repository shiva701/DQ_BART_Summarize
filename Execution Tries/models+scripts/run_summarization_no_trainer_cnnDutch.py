...
def main():
    ...
    if args.model_name_or_path:
        ...
        #changes done here to set decoder start token id
    ...
    #changes for mbart Dutch language
    # if args.tokenizer_name == "facebook/mbart-large-cc25":
    #    print("\n\n\n Setting tokenizer lang to  code id")
    #    teacher_model.config.decoder_start_token_id = tokenizer.lang_code_to_id["nl_XX"]
    #    student_model.config.decoder_start_token_id = tokenizer.lang_code_to_id["nl_XX"]
