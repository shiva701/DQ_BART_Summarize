...
summarization_name_mapping = {
    ...
    "Gabriel/cnn_daily_swe": ("article", "highlights"),
    "ml6team/xsum_nl": ("document", "summary"),
    "ARTeLab/mlsum-it": ("source","target")
}
...
def parse_args():
    ...
    datasetName = None
    if args.dataset_name == "Rahmaa/eli5_final":
        datasetName = "Rahmaa_eli5_final"
    elif args.dataset_name == "ml6team/cnn_dailymail_nl":
        datasetName = "ml6team_cnn_dailymail_nl"
    elif args.dataset_name == "Gabriel/cnn_daily_swe":
        datasetName = "Gabriel_cnn_daily_swe"
    elif args.dataset_name == "ml6team/xsum_nl":
        datasetName = "ml6team_xsum_nl"
    elif args.dataset_name == "ARTeLab/mlsum-it":
        datasetName = "ARTeLab_mlsum-it"
    else:
        datasetName = args.dataset_name

    args.output_dir = f'./output_{datasetName}/{args.weight_bits}_{args.input_bits}_{args.distill_encoder}_{args.distill_decoder}_{args.num_train_epochs}_{args.learning_rate}_fp16'
    if args.new_distill_map:
    ...
    # dataset configuration done here.
    if args.dataset_name == "xsum":
        ...
        args.min_length = 56
        args.num_beams = 4
    elif args.dataset_name == "Rahmaa/eli5_final":
        args.length_penalty = 1.0
        args.max_length = 125
        args.min_length = 36
        args.num_beams = 4
...
def main():
    ...
    if is_master:
        ...
        print("\n\nthe args output_dir is: ", args.output_dir)
    ...
    if args.tokenizer_name:
        ...
        if args.model_name_or_path == "facebook/mbart-large-50":
            print("\n\n\n ******* updating the tokenizer ********* \n\n\n")
            tokenizer = AutoTokenizer.from_pretrained(args.tokenizer_name, use_fast=not args.use_slow_tokenizer, src_lang="sv_SE", tgt_lang="sv_SE")
        # changed done
        else:
    ...
    if args.model_name_or_path:
        ...
        if args.model_name_or_path == "facebook/mbart-large-50":
            teacher_model.config.decoder_start_token_id = tokenizer.lang_code_to_id['sv_SE']
        #changes done
    ...
    # print("\n\n\n Checking column names: ", column_names)
    # print("\n\n\n Checking summary column: ", summary_column)
    ...
    def preprocess_function(examples):
        ...
        # print("\n\n type of examples: ", type(examples))
        # print("\n\n Targets to encode is: ", targets[:2])
        # print("\n\n Type of Targets to encode is: ", type(targets))
        # print("\n\n Type of Targets to encode is: ", type(targets[0]))
        # print("\n\n Summary Column is: ", summary_column)
    ...
    # here, we can change the dataset size base on our requirements
    # print("\n\n\nThe processed dataset is: ", processed_datasets)
    ...
    if torch.cuda.is_available():
        ...
        print(f"Yes, cuda is available, Found device: {device_name}, n_gpu: {n_gpu}")
