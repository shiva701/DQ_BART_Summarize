...
summarization_name_mapping = {
    ...
    "yhavinga/xsum_dutch": ("document", "summary")
}
...
def parse_args():
    ...
    elif args.dataset_name == "yhavinga/xsum_dutch":
        datasetName = "yhavinga_xsum_dutch"    
    else:
...
def main():
    ...
    if args.tokenizer_name:
        ...
        if args.tokenizer_name == "facebook/mbart-large-50":
